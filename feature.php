<div id="feature">
    <div class="item">
        ...
        <div class="flex">
            <div class="flexwrap">
                <h3><?php echo (get_theme_mod('TokoWA_featured_title1') ? get_theme_mod('TokoWA_featured_title1') : 'Bisa COD / Pick-up!'); ?></h3>
                ...
                <p><?php echo (get_theme_mod('TokoWA_featured_desc1') ? get_theme_mod('TokoWA_featured_desc1') : 'Untuk area <a href="https://www.google.com/maps/search/'.$alamat_toko_kota.'" target="_blank"><b>'.$alamat_toko_kota.'</b></a> & sekitarnya..'); ?></p>
            </div>
        </div>
    </div>
    <div class="item">
