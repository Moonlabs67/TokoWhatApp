        ...
        <div class="footerGrid">
            ...
            <div class="item custom">
                ...
                <div>
                    ...
                    <br/>
                    <br/>
                    <small>Copyright &#0169; <?php echo date('Y'); ?> - <?php bloginfo('name'); ?> | Created by <a target='_blank' href="https://www.inspiracomputer.com"</a> Inspira </small>
                </div>
            </div>
        </div>
    </div>
...
<script defer='defer' src="<?php echo get_template_directory_uri(); ?>/lib/jquery.max.js"></script>
